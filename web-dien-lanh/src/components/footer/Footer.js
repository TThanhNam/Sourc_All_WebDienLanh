      ...
      <div className='footer-infor col-lg-12'>
        ...
        <div className='about-us-container col-lg-2 col-12'>
          ...
          <div className='icon-contact'>
            <ul className='col-12'>
              <li className='col-3'>
                <a href={URL.FACEBOOK}><i className="fab fa-facebook-f icon"></i></a>
              </li>
              <li className='col-3'>
                <a href={URL.ZALO}>
                  <svg className={"icon"} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="250" height="250" viewBox="0 0 50 50">
                    <path
